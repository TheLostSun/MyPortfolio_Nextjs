  ...
  return (
    <div className="lg:flex my-12 w-7/8 p-8 rounded-xl drop-shadow-2xl shadow-md h-full bg-slate-800 mx-8">
      <div className="lg:w-1/2">
        ...
        <p
          className={`max-lg:text-center text-rose-100 font-base my-0 transition-all duration-300 
            ${!expanded ? "line-clamp-5 overflow-hidden" : ""}`}
        >
          {props.content}
        </p>

        {/* Right-aligned toggle button on mobile */}
        <div className="max-lg:flex max-lg:justify-end mb-5 lg:hidden">
          <button
